    ...
    <Card className="shadow-sm border-slate-200 hover:shadow-md transition-shadow">
      <CardContent className="p-5 flex items-center justify-between">
        <div>
          ...
          <h2 className="text-xl font-bold text-slate-900 truncate max-w-[150px]" title={repoName}>{repoName}</h2>
          <div className="flex items-center mt-2">
            <span className="px-2 py-0.5 rounded text-xs font-medium bg-slate-100 text-slate-600">branch: {branchName}</span>
          </div>
        </div>
