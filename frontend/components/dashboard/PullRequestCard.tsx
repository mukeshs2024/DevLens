      ...
      <CardContent className="p-5 flex items-center justify-between">
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-slate-900 truncate max-w-[120px]">Fix payment validation logic</span>
          </div>
          <div className="flex items-center gap-2 mt-2">
            <div className="h-5 w-5 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center text-[10px] font-bold shrink-0">
              JD
            </div>
